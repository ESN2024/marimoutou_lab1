...
module lab1_mm_interconnect_0 (
		...
		input  wire        BTN_reset_reset_bridge_in_reset_reset,          //          BTN_reset_reset_bridge_in_reset.reset
		...
		output wire        BTN_s1_write,                                   //                                         .write
		input  wire [31:0] BTN_s1_readdata,                                //                                         .readdata
		output wire [31:0] BTN_s1_writedata,                               //                                         .writedata
		output wire        BTN_s1_chipselect,                              //                                         .chipselect
	...
	wire  [17:0] btn_s1_agent_m0_address;                                                            // BTN_s1_agent:m0_address -> BTN_s1_translator:uav_address
	...
	wire  [94:0] btn_s1_agent_rf_source_data;                                                        // BTN_s1_agent:rf_source_data -> BTN_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] btn_s1_agent_rsp_fifo_out_data;                                                     // BTN_s1_agent_rsp_fifo:out_data -> BTN_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> BTN_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> BTN_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // BTN_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> BTN_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> BTN_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> BTN_s1_agent:cp_endofpacket
	...
	wire         btn_s1_agent_rp_valid;                                                              // BTN_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] btn_s1_agent_rp_data;                                                               // BTN_s1_agent:rp_data -> router_006:sink_data
	wire         btn_s1_agent_rp_ready;                                                              // router_006:sink_ready -> BTN_s1_agent:rp_ready
	wire         btn_s1_agent_rp_startofpacket;                                                      // BTN_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         btn_s1_agent_rp_endofpacket;                                                        // BTN_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         btn_s1_agent_rdata_fifo_src_valid;                                                  // BTN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] btn_s1_agent_rdata_fifo_src_data;                                                   // BTN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         btn_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_004:in_0_ready -> BTN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> BTN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> BTN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // BTN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> BTN_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (BTN_reset_reset_bridge_in_reset_reset), //                    reset.reset
		...
		.av_write               (BTN_s1_write),                          //                         .write
		.av_readdata            (BTN_s1_readdata),                       //                         .readdata
		.av_writedata           (BTN_s1_writedata),                      //                         .writedata
		.av_chipselect          (BTN_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                           //             clk.clk
		.reset                   (BTN_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab1_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (BTN_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
